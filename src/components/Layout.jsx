...
export default function Layout({ children }) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-panda-950 text-panda-100">
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <aside className="flex w-72 flex-col gap-6 border-l border-panda-700/50 bg-panda-900 p-6 shadow-soft transition-transform duration-200 ease-out">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-panda-700/50 bg-panda-800/80 text-panda-200 transition hover:border-panda-600 hover:text-white"
                onClick={closeMobile}
            ...
            <div className="mt-auto pt-6 border-t border-panda-700/50">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-panda-700/50 bg-panda-800/80 text-panda-300 transition hover:border-bamboo-500/30 hover:text-bamboo-400"
                  aria-label="Instagram"
                >
      ...
      <footer className="border-t border-panda-800/50 bg-panda-900/50 py-12">
